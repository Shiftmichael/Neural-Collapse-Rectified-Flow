...
from utils_reflow.utils import seed_everything
...
flags.DEFINE_string("model", "reflow", help="flow matching model type")
...
for i in range(1, 12, 1):
    # Load the model
    PATH = f"{FLAGS.input_dir}/{FLAGS.model}/{FLAGS.model}_{i}_5.pt"
    print("path: ", PATH)
...
# CUDA_VISIBLE_DEVICES=1 python compute_fid_cifar10.py